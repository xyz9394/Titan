...
public class MongoDBTableCreation {
  ...
  public static void main(String[] args) throws ParseException {
    ...
    db.getCollection("users")
        .insertOne(new Document().append("first_name", "Xinyuan").append("last_name", "Zheng")
            .append("password", "85f126b09e1201ef817b7e2dcc345f99").append("user_id", "zhengxy"));
    db.getCollection("users")
    .insertOne(new Document().append("first_name", "Public").append("last_name", "Guest")
